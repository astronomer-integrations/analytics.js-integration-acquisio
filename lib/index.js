...
.option('events', '')
.option('advertiserId', '')
.tag('<script src="https://js.adsrvr.org/up_loader.1.1.0.js" type="text/javascript"></script>')
...
Acquisio.prototype.initialize = function() {
    var code = '<script type="text/javascript">(function(global) {if (typeof TTDUniversalPixelApi === "function") {var universalPixelApi = new TTDUniversalPixelApi();universalPixelApi.init("' + this.options.advertiserId + '", ["nwzwuyj"], "https://insight.adsrvr.org/track/up", "ttdUniversalPixelTagb36891b1ae0c43c58ed7c4959ea61e43");}})(this);</script>';
