...
Acquisio.prototype.initialize = function() {
    var scriptText = '(function(global) {if (typeof TTDUniversalPixelApi === "function") {var universalPixelApi = new TTDUniversalPixelApi();universalPixelApi.init("' + this.options.advertiserId + '", ["nwzwuyj"], "https://insight.adsrvr.org/track/up", "ttdUniversalPixelTagb36891b1ae0c43c58ed7c4959ea61e43");}})(this);';
    ...
    codeElement.appendChild(document.createTextNode(scriptText));
